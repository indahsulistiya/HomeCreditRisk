...
def main():       
    ...
    NAME_TYPE_SUITE = st.radio('Name Type Suite',("Children", "Family", "Group of people", "Other_A", "Other_B", "Spouse Partner", "Unaccompanied"))
    ...
    NAME_EDUCATION_TYPE = st.radio('Name Education Type',("Academic degree", "Higher education", "Incomplete higher", "Lower secondary", "Secondary / secondary special"))
    ...
    APARTMENTS_MODE = st.number_input('APARTMENTS_MODE')
    
    YEARS_BEGINEXPLUATATION_MODE = st.number_input('YEARS_BEGINEXPLUATATION_MODE')
    
    YEARS_BEGINEXPLUATATION_MEDI = st.number_input('YEARS_BEGINEXPLUATATION_MEDI')
    
    APARTMENTS_MEDI = st.number_input('APARTMENTS_MEDI')
